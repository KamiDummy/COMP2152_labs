...
input("Roll for the first item (Enter)")
...
#sort
print("You got the loots so organize your bekt")
belt.sort()
print("Your belt: ", belt)

#use belt
print("You see a monster in distance! quickly use your ")
first_item = belt.pop(0)
if first_item in good_loot_options:
    health_points = min(6, (health_points + 2))
    print (f"You used the {first_item} item and your health is {health_points} points.")
elif first_item in bad_loot_options:
    health_points = min(0, (health_points + 2))
    print(f"You used the {first_item} item and your health is {health_points}.")
else:
    print(f"You used the {first_item} item and it was not useful")
...
input("Roll for the Monsters magic power")
power_roll = random.choice(["Fire magic", "Freezing Time", "Super Hearing"])

#increase monster combat strentgth
m_combat_strength = min(6, (m_combat_strength + monster_power[power_roll]))
print("Monster combat strentgh is now ") + str(m_combat_strength) + "Using the " + power_roll + " magic power"
