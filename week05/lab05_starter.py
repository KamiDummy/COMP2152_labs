...
if not input_invalid:
  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    loot_options, belt = functions_lab05_starter.collect_loot(loot_options, belt)
    print("    ------------------------------------------------------------------")
    print("    |", end="    ")
    ...
    belt, health_points = functions_lab05_starter.use_loot(belt, health_points)
    ...
    if num_dream_lvls != 0:
        health_points -= 1
        crazy_level = functions_lab05_starter.inception_dream(num_dream_lvls)
